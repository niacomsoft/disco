...
namespace Disco
{
  public static partial class AssertUtilities
  {
    ...
    ///   <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool BetweenAnd(double value, double minimum = double.MinValue, double maximum = double.MaxValue, bool minimumInclusive = true, bool maximumInclusive = false)
    {
    ...
    ///   当 <c> <paramref name="a" /> = <paramref name="b" /></c> 时，返回 <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Equals(double a, double b = 0) => a == b;
    ...
    ///   。
    /// </returns>
    public static bool GreaterThan(double a, double b = 0) => a > b;
    ...
    ///   。
    /// </returns>
    public static bool GreaterThanOrEquals(double a, double b = 0) => a >= b;
    ...
    ///   。
    /// </returns>
    public static bool LessThan(double a, double b = 0) => a < b;
    ...
    ///   。
    /// </returns>
    public static bool LessThanOrEquals(double a, double b = 0) => a <= b;
