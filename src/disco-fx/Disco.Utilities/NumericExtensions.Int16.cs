...
namespace Disco
{
  public static partial class NumericExtensions
  {
    ...
    ///   <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Between(this short me, short min = 0, short max = short.MaxValue, bool minInclusive = true, bool maxInclusive = true)
    {
      return
    ...
    ///   <paramref name="me" />.Value </c>。
    /// </returns>
    public static short DefaultIf(this short? me, short @default = 0)
    {
      return me ?? @default;
    }
    ...
    ///   当 <c> <paramref name="me" /> = <paramref name="b" /></c> 时，返回 <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Equals(this short me, short b = 0)
    {
      return me.Equals(b);
    }
    ...
    ///   。
    /// </returns>
    public static bool GreaterThan(this short me, short b = 0)
    {
      return me > b;
    }
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool GreaterThanOrEquals(this short me, short b = 0)
    {
      return me >= b;
    }
    ...
    ///   。
    /// </returns>
    public static bool LessThan(this short me, short b = 0)
    {
      return me < b;
    }
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool LessThanOrEquals(this short me, short b = 0)
    {
      return me <= b;
    }
