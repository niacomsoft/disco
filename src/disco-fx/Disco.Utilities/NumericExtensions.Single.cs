...
namespace Disco
{
  public static partial class NumericExtensions
  {
    ...
    /// </param>
    /// <param name="min">
    ///   下限 <see cref="float" /> 类型的值。
    /// </param>
    /// <param name="max">
    ///   上限 <see cref="float" /> 类型的值。
    /// </param>
    ...
    ///   <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Between(this float me, float min = 0, float max = float.MaxValue, bool minInclusive = true, bool maxInclusive = true)
    {
      return
    ...
    ///   <paramref name="me" />.Value </c>。
    /// </returns>
    public static float DefaultIf(this float? me, float @default = 0)
    {
      return me ?? @default;
    }
    ...
    ///   当 <c> <paramref name="me" /> = <paramref name="b" /></c> 时，返回 <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Equals(this float me, float b = 0)
    {
      return me.Equals(b);
    }
    ...
    ///   。
    /// </returns>
    public static bool GreaterThan(this float me, float b = 0)
    {
      return me > b;
    }
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool GreaterThanOrEquals(this float me, float b = 0)
    {
      return me >= b;
    }
    ...
    ///   。
    /// </returns>
    public static bool LessThan(this float me, float b = 0)
    {
      return me < b;
    }
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool LessThanOrEquals(this float me, float b = 0)
    {
      return me <= b;
    }
