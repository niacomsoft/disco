...
namespace Disco
{
  public static partial class AssertUtilities
  {
    ...
    ///   <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool BetweenAnd(decimal value, decimal minimum = decimal.MinValue, decimal maximum = decimal.MaxValue, bool minimumInclusive = true, bool maximumInclusive = false)
    {
    ...
    ///   当 <c> <paramref name="a" /> = <paramref name="b" /></c> 时，返回 <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Equals(decimal a, decimal b = 0) => a == b;
    ...
    ///   。
    /// </returns>
    public static bool GreaterThan(decimal a, decimal b = 0) => a > b;
    ...
    ///   。
    /// </returns>
    public static bool GreaterThanOrEquals(decimal a, decimal b = 0) => a >= b;
    ...
    ///   。
    /// </returns>
    public static bool LessThan(decimal a, decimal b = 0) => a < b;
    ...
    ///   。
    /// </returns>
    public static bool LessThanOrEquals(decimal a, decimal b = 0) => a <= b;
