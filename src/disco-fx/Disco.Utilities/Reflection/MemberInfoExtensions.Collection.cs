...
namespace Disco.Reflection
{
  ...
  public static partial class MemberInfoExtensions
  {
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool TryGetCustomAttributes(this MemberInfo me, Type attributeType, bool inherit, out Attribute[] attributes)
    {
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool TryGetCustomAttributes<TAttribute>(this MemberInfo me, bool inherit, out TAttribute[] attributes) where TAttribute : Attribute
    {
      attributes = me.GetCustomAttributes<TAttribute>(inherit)?.ToArray();
      return attributes.HasItems();
    }
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool TryGetCustomAttributes<TAttribute>(this MemberInfo me, out TAttribute[] attributes) where TAttribute : Attribute
    {
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool TryGetCustomAttributes(this MemberInfo me, Type attributeType, out Attribute[] attributes)
    {
