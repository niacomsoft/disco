...
namespace Disco
{
  public static partial class NumericExtensions
  {
    ...
    /// </param>
    /// <param name="min">
    ///   下限 <see cref="decimal" /> 类型的值。
    /// </param>
    /// <param name="max">
    ///   上限 <see cref="decimal" /> 类型的值。
    /// </param>
    ...
    ///   <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Between(this decimal me, decimal min = 0, decimal max = decimal.MaxValue, bool minInclusive = true, bool maxInclusive = true)
    {
      return
    ...
    ///   <paramref name="me" />.Value </c>。
    /// </returns>
    public static decimal DefaultIf(this decimal? me, decimal @default = 0)
    {
      return me ?? @default;
    }
    ...
    ///   当 <c> <paramref name="me" /> = <paramref name="b" /></c> 时，返回 <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Equals(this decimal me, decimal b = 0)
    {
      return me.Equals(b);
    }
    ...
    ///   。
    /// </returns>
    public static bool GreaterThan(this decimal me, decimal b = 0)
    {
      return me > b;
    }
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool GreaterThanOrEquals(this decimal me, decimal b = 0)
    {
      return me >= b;
    }
    ...
    ///   。
    /// </returns>
    public static bool LessThan(this decimal me, decimal b = 0)
    {
      return me < b;
    }
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool LessThanOrEquals(this decimal me, decimal b = 0)
    {
      return me <= b;
    }
