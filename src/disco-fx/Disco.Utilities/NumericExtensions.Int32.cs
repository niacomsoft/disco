...
namespace Disco
{
  public static partial class NumericExtensions
  {
    ...
    ///   <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Between(this int me, int min = 0, int max = int.MaxValue, bool minInclusive = true, bool maxInclusive = true)
    {
      return
    ...
    ///   <paramref name="me" />.Value </c>。
    /// </returns>
    public static int DefaultIf(this int? me, int @default = 0)
    {
      return me ?? @default;
    }
    ...
    ///   当 <c> <paramref name="me" /> = <paramref name="b" /></c> 时，返回 <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Equals(this int me, int b = 0)
    {
      return me.Equals(b);
    }
    ...
    ///   。
    /// </returns>
    public static bool GreaterThan(this int me, int b = 0)
    {
      return me > b;
    }
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool GreaterThanOrEquals(this int me, int b = 0)
    {
      return me >= b;
    }
    ...
    ///   。
    /// </returns>
    public static bool LessThan(this int me, int b = 0)
    {
      return me < b;
    }
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool LessThanOrEquals(this int me, int b = 0)
    {
      return me <= b;
    }
