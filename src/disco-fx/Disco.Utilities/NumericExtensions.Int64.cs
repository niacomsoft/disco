...
namespace Disco
{
  public static partial class NumericExtensions
  {
    ...
    ///   <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Between(this long me, long min = 0, long max = long.MaxValue, bool minInclusive = true, bool maxInclusive = true)
    {
      return
    ...
    ///   <paramref name="me" />.Value </c>。
    /// </returns>
    public static long DefaultIf(this long? me, long @default = 0)
    {
      return me ?? @default;
    }
    ...
    ///   当 <c> <paramref name="me" /> = <paramref name="b" /></c> 时，返回 <see langword="true" />；否则返回 <see langword="false" /> 。
    /// </returns>
    public static bool Equals(this long me, long b = 0)
    {
      return me.Equals(b);
    }
    ...
    ///   。
    /// </returns>
    public static bool GreaterThan(this long me, long b = 0)
    {
      return me > b;
    }
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool GreaterThanOrEquals(this long me, long b = 0)
    {
      return me >= b;
    }
    ...
    ///   。
    /// </returns>
    public static bool LessThan(this long me, long b = 0)
    {
      return me < b;
    }
    ...
    ///   <see langword="false" /> 。
    /// </returns>
    public static bool LessThanOrEquals(this long me, long b = 0)
    {
      return me <= b;
    }
